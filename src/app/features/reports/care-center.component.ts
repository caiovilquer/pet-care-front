...
@Component({
  ...
  styles: [`
    ...
    @media print{
      .center-hero{display:none}
      .tab-content{padding:0}
      :host ::ng-deep .mat-mdc-tab-header{display:none}
      :host ::ng-deep .mat-mdc-tab-body:not(.mat-mdc-tab-body-active){display:none!important}
      /* overflow/position dos wrappers de tab cortam a paginação da impressão */
      :host ::ng-deep .mat-mdc-tab-body-wrapper,
      :host ::ng-deep .mat-mdc-tab-body.mat-mdc-tab-body-active,
      :host ::ng-deep .mat-mdc-tab-body-content{overflow:visible!important;position:static!important;transform:none!important}
    }
  `]
})
